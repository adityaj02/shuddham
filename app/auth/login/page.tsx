...
export const metadata = {
  title: "Sign In | SHUDDHAM",
  description: "Sign in to your SHUDDHAM account to manage your wellness journey.",
};
    ...
    <div className="flex min-h-screen flex-col items-center justify-center p-6 bg-surface">
      <div className="w-full max-w-md space-y-8 text-center animate-in fade-in slide-in-from-bottom-8 duration-700">
        ...
        <div className="bg-white p-8 rounded-3xl shadow-xl shadow-primary/5 border border-primary/5 flex flex-col items-center gap-6">
          ...
          {/* Suspense boundary required because GoogleLoginButton uses useSearchParams */}
          <Suspense fallback={
            <div className="flex items-center gap-3 bg-white px-6 py-3 rounded-full border border-neutral-200">
              <div className="h-5 w-5 border-2 border-neutral-300 border-t-primary rounded-full animate-spin" />
              <span className="font-medium text-sm text-neutral-500">Loading...</span>
            </div>
          }>
            <GoogleLoginButton />
          </Suspense>
