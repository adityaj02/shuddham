...
export default async function ProfilePage() {
  ...
  const [addresses, orders] = await Promise.all([
    getUserAddresses(userRecord.id),
    getOrdersByUser(userRecord.id),
  ]);
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 space-y-8">
      ...
      <section className="bg-surface-container-lowest rounded-xl p-6 shadow-[0px_20px_40px_rgba(28,28,22,0.06)] border border-outline-variant/10">
        ...
        <Link href="/ayurveda" className="relative p-6 rounded-xl bg-surface-container-low overflow-hidden group cursor-pointer transition-all hover:bg-surface-container-high block">
