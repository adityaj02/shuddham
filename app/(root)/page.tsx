  ...
  return (
    <div className="page-shell space-y-12">
      ...
      <section className="relative h-[480px] w-full rounded-xl overflow-hidden group">
        <Image
          src="https://lh3.googleusercontent.com/aida-public/AB6AXuCGsqMbyhgERqEMFzOkuX0PWQYzLP5CVVkJwfsK5bfy-0VBxMZR69sMzalGNQNyDUEBWRvkVVcvJS3w9PtblDqtdzZP4CbA9An5d3SdItnQIrH5AK5h_-GONAQzms6UlxJDdsQ_XWx8lpKS_DCxtDg5k7OlKJMsHmtz4tW1fwNDFaijBzQDIFsIkcOG6v9_Okdj-SzCf2W9WQYkkfdf19gneowyczKbmDAl2sqpSABKi328rQRDKPzXum8LOJ-3DSbTYOv6gG7YH4k"
          alt="Zen-like forest scene with soft morning mist rolling over ancient green trees and filtered sunlight rays."
          fill
        ...
        <div className="flex gap-6 overflow-x-auto hide-scrollbar snap-x snap-mandatory pb-4 select-none">
          {featuredProducts.map((product, index) => {
            ...
            return (
              <BorderGlow
                key={product.id}
                className="min-w-[280px] rounded-xl p-4 snap-start shadow-[0px_20px_40px_rgba(28,28,22,0.04)] block"
