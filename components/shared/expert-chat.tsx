          ...
          <div className="flex flex-wrap gap-2 justify-center w-full animate-in fade-in slide-in-from-bottom-2 duration-300">
            {expecting.options.map((opt) => (
              <Button
                ...
                className="rounded-full bg-surface hover:bg-primary-fixed hover:text-on-primary-fixed text-primary text-xs font-bold border border-primary/10 transition-colors shadow-sm"
              >
                {opt}
              </Button>
            ))}
